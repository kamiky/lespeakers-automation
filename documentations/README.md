...
> Plan d'origine : [`action_plan.md`](./action_plan.md)

---

## Scripts (dans l'ordre du pipeline)

| Step | Script (`scripts/`)                                                  | En 1 ligne                                                                                            | Tech                | Coût      | Doc                                                                                                  |
|------|----------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|---------------------|-----------|------------------------------------------------------------------------------------------------------|
...
| 3    | _à venir_                                                            | Découverte des employés clés (CEO, founder, partnerships) sur chaque page LinkedIn company.           | Apify LinkedIn      | $$        | -                                                                                                    |
