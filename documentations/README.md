...
- **[`open_agencies_linkedin/README.md`](./open_agencies_linkedin/README.md)** — boucle interactive `yarn outreach:linkedin` : ouvre les LinkedIn **entreprise** par défaut (option `--employees` pour les profils), dans Chrome, et track `linkedin_connected` / `linkedin_first_message` dans le JSON.
